...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact Nigeria Lex — research, editorial, partnerships, events and general enquiries.",
...
export default async function ContactPage() {
  ...
  const lagos =
    settings?.correspondence?.lagos ||
    "Nigeria Lex correspondence address to be confirmed.";
  const london =
    settings?.correspondence?.london ||
  ...
  return (
    <div className="container max-w-2xl py-16 md:py-20">
          ...
          {departments.map((dept: any) => (
            ...
            >
              ...
              <a
                ...
                className="text-[14px] font-medium text-green"
              >
                {dept.email}
              </a>
            </li>
      ...
      <section className="mt-12 border-t border-line pt-10">
        <h2 className="font-serif text-lg text-navy">Send a message</h2>
        <p className="mt-2 text-[14px] leading-relaxed text-slate">
          Prefer not to email directly? Use the form below and we&rsquo;ll route
      ...
      <section className="mt-12 border-t border-line pt-10">
        ...
        <div className="mt-4 grid gap-6 sm:grid-cols-2">
          <div>
            ...
            <p className="mt-1 whitespace-pre-line text-[15px] text-navy-ink">
              {lagos}
            </p>
          </div>
          <div>
