...
export default function Page() {
  return (
    <div className="container max-w-2xl py-16 md:py-20">
      ...
      <h1 className="mt-2 font-serif text-3xl text-navy md:text-4xl">Terms of Use</h1>
      <p className="mt-6 text-[15px] leading-relaxed text-navy-ink">
        This Terms of Use is being finalised with Nigeria Lex&rsquo;s legal counsel and will be
